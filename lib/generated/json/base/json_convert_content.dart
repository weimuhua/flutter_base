...
class JsonConvert {
  static final Map<String, JsonConvertFunction> _convertFuncMap = {
    (ConfigRspEntity).toString(): ConfigRspEntity.fromJson,
    (ConfigRspData).toString(): ConfigRspData.fromJson,
    (ConfigRspDataConfig).toString(): ConfigRspDataConfig.fromJson,
  };
